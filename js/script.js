...
const GAME_MODES = Object.freeze([
  {
    ...
    label: "Easy",
    durationSeconds: 90,
    description: "Relaxed pace for detailed sketches.",
  },
  {
    key: "medium",
    label: "Medium",
    durationSeconds: 60,
    description: "Balanced speed and challenge.",
  },
  {
    key: "hard",
    label: "Hard",
    durationSeconds: 30,
    description: "Fast rounds that test quick ideas.",
  },
  {
    key: "hardcore",
    label: "Hardcore",
    durationSeconds: 15,
    description: "Intense speedrun drawing mode.",
  },
  {
    key: "finish_sketch",
